...
dom.importCssString(require("ace/requirejs/text!layout/styles/dropdown.css"), "dropdown.css");
dom.importCssString(require("ace/requirejs/text!layout/styles/menu.css"), "menu.css");
